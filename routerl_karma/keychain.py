class Keychain:
    ...
    MANHATTAN = "manhattan"
    SAINT_ARNOULD = "saint_arnoult"
    NETWORK_NAMES = [ARTERIAL, COLOGNE, CSOMOR, GRID, INGOLSTADT, NGUYEN, ORTUZAR, TWO_ROUTE_YIELD, MANHATTAN, SAINT_ARNOULD]
