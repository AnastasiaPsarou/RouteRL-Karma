...
CONFIG_FILE = "../network_base/simulation.sumocfg"

# Template .rou file to modify per run
ROU_TEMPLATE = "../network_base/routes.rou.xml"

# Flow ID to modify in the .rou file
FLOW_ID = "flow_am_peak"

# Vehicle counts for each run (cycled if fewer than RUNS)
COUNTS = [10, 100, 200, 300, 400, 500, 600, 700, 800, 900]#, 1000, 2000, 5000, 10000]

# SUMO / execution settings
RUNS = 10           # how many total runs
PARALLEL = 10       # how many in parallel
