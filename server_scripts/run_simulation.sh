...
PATH_PROGRAM="/home/$USER/RouteRL-Karma"
PUT_PROGRAM_TO="/app"
PATH_SUMO_CONTAINER="/shared/sets/singularity/sumo.sif"
CMD_PATH="/home/$USER/RouteRL-Karma/server_scripts/cmd_container.sh"
PRINTS_SAVE_PATH="/home/$USER/RouteRL-Karma/server_scripts/container_printouts/output_$SLURM_JOB_ID.txt"
