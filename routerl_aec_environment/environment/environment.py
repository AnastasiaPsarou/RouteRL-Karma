...
from routerl_aec_environment.services import Recorder
from routerl_aec_environment.utilities import get_params
...
class TrafficEnvironment(AECEnv):
    ...
    def __init__(self,
        ...
        self.urgency_distribution = np.clip(self.urgency_distribution, 0, 10) / 10 # restrict to 1–10
